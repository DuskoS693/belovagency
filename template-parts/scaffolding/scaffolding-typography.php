...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'wp-test-domain' ); ?>">
		<?php esc_html_e( 'Typography', 'wp-test-domain' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>WP Test</del>',
			'output'      => '<p>We use <del>WP Test</del> wd_s to build themes.</p>',
		]
	);
