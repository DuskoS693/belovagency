...
use function wd_s\print_global_scaffolding_section;

?>

<section class="section-scaffolding">

	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'globals', 'wp-test-domain' ); ?>"><?php esc_html_e( 'Globals', 'wp-test-domain' ); ?></h2>
