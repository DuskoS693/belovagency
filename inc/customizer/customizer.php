...
function customize_scripts() {
	wp_enqueue_script( 'wp-test-domain-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
...
function selective_refresh_support( $wp_customize ) {
	...
	$settings = [
		...
		'wp_test_domain_copyright_text' => '.site-info',
	];
